...
;G90                          ; Absolute Mode.
;G53 G0 X{TOOL X PARKING POST X POSITIONG} Y275 F6000
...
; -------- circular -------
G91 							; Relative mode
G1 Z{33+TOOL X Z OFFSET}		; Z dive allowing the carriage (Z33) plus
								; tool (+TOOL Z OFFSET) to clear the bed
G90								; absolute mode
G53 G0 X{TOOL X PARKING POST X POSITION} Y{275-169.55} F6000		; controlled move to back of post
...
G91								; relative mode
G1 Z{-33-TOOL X Z OFFSET}		; move bed back up
